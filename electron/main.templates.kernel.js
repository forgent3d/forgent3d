...
const KERNELS = ['build123d', 'cadquery'];
...
const KERNEL_META = {
  ...
  cadquery: {
    ...
    cacheExt: '.brep',
    runner: 'python',
    blurb: 'Mature Python OCCT-based CAD DSL with chainable Workplane APIs and precise face picking after BREP export.'
  }
};
...
function kernelExpertise(kernel) {
  return kernelPromptBundle(assertKernel(kernel)).expertise;
}
