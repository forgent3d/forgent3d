...
function baseMarkdown(agentHint) {
  ...
  md += `Current CAD kernel: **build123d (Python)**. Single bodies use \`models/<name>/part.py\` + \`params.json\`; assemblies use \`models/<name>/asm.xml\` + \`params.json\`. Validate through the viewer MCP tools.\n\n`;
