...
const messages = {
  en: {
    ...
    newModel: 'New Model',
    newModelHelp: 'This creates parts/&lt;name&gt;/part.py or assemblies/&lt;name&gt;/asm.xml and README.md. Name can only contain letters, numbers, underscores, and hyphens.',
    ...
    rebuildModelTitle: 'Rebuild this model (part models also refresh parts/<name>/<name>.stl)',
