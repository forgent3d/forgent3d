...
const messages = {
  en: {
    ...
    wire: 'Wire',
    face: 'Face',
    selectBrepFace: 'Select BREP face',
    selectBrepFaceUnavailable: 'Load a BREP preview to select faces',
    ...
    dir_left: 'left',
    dir_right: 'right',
    copyFaceSelector: 'Copy face selector',
    faceSelectorCopied: 'Face selector copied',
    ...
    nextAgent: 'Forgent3D (Beta)',
    newModel: 'New Model',
    newModelHelp: 'This creates models/&lt;name&gt;/assembly.py, params.json, and local parts/&lt;part&gt;/part.py files. Add asm.xml only for optional motion preview.',
    ...
    assemblyKind: 'Assembly (assembly.py)',
    cancel: 'Cancel',
    create: 'Create',
    ...
    loadingMotion: 'Loading motion preview',
    parsingGlb: 'Parsing GLB',
    ...
    motionPreviewReady: 'Motion preview',
    glbModel: 'GLB model',
    stlMesh: 'STL mesh',
    ...
    shareTitle: 'Share',
    shareLinkHint: 'Anyone with the link can view.',
    sharePublicLine: 'Show in gallery — listed on forgent3d.com',
    shareLinkLabel: 'Link',
    shareLinkPlaceholder: 'Create a link first',
    shareCopy: 'Copy',
    shareUnshare: 'Remove link',
    shareClose: 'Close',
    shareCreateLink: 'Create link',
    shareUpdateSnapshot: 'Update snapshot',
    shareLoading: 'Loading…',
    sharePublishing: 'Uploading…',
    shareLinkReady: 'Link ready.',
    shareRemoved: 'Link removed.',
    sharePublicUpdated: 'Gallery setting updated.',
  ...
  'zh-CN': {
    ...
    wire: '线框',
    face: '选面',
    selectBrepFace: '选择 BREP 面',
    selectBrepFaceUnavailable: '加载 BREP 预览后可选择面',
    selectedBrepFace: '已选择面 #{index}',
    surfaceType: '{type}',
    selectorMatches: '{count} 个匹配',
    faceDirection: '{dir}面',
    faceComponent: '所属 {name}',
    dir_top: '顶',
    dir_bottom: '底',
    dir_front: '前',
    dir_back: '后',
    dir_left: '左',
    dir_right: '右',
    copyFaceSelector: '复制面选择器',
    faceSelectorCopied: '已复制面选择器',
    viewControls: '视图控制',
    showcase: '展示',
    explode: '爆炸图',
    ...
    nextAgent: 'Forgent3D (Beta)',
    newModel: '新建模型',
    newModelHelp: '这会创建 models/&lt;name&gt;/assembly.py、params.json，以及本地 parts/&lt;part&gt;/part.py。只有需要运动预览时才额外添加 asm.xml。',
    ...
    shareTitle: '分享',
    shareLinkHint: '知道链接的人可查看。',
    sharePublicLine: '公开展示 — 出现在 forgent3d.com 模型库',
    shareLinkLabel: '链接',
    shareLinkPlaceholder: '请先创建链接',
    shareCopy: '复制',
    shareUnshare: '取消分享',
    shareClose: '关闭',
    shareCreateLink: '创建链接',
    shareUpdateSnapshot: '更新快照',
    shareLoading: '加载中…',
    sharePublishing: '上传中…',
    shareLinkReady: '链接已就绪。',
    shareRemoved: '已取消分享。',
    sharePublicUpdated: '公开展示已更新。',
