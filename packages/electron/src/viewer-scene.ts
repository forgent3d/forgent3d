...
export function createViewerLighting(
  scene: THREE.Scene,
  ...
  function updateDirectionalLights(viewCamera: THREE.Camera, orbitTarget: THREE.Vector3) {
  ...
  function updateShadowCameraForBox(box: THREE.Box3) {
...
export function decorateModelForCadDisplay(root: THREE.Object3D) {
  root.traverse((child) => {
